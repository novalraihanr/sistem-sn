...
export default function VendorPartsPage() {
    const { props } = usePage();
    ...
    const handleUpdateVendorPartSubmit = async (e: React.FormEvent) => {
        ...
        try {
            console.log('Updating vendor part:', { vendorId: vendor.id_vendor, partId: editingVendorPart.part_id, harga_part: parseFloat(editingVendorPart.harga_part), merk_part: editingVendorPart.merk_part });
    ...
    return (
        <AppLayout>
            <Head title={`Parts for ${vendor.nama_vendor}`} />
            <div className="container mx-auto py-10">
                <div className="flex justify-between items-center mb-4">
                    <h1 className="text-2xl font-bold">Parts for {vendor.nama_vendor}</h1>
