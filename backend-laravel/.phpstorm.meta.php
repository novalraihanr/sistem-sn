...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/neru/Projects/Webdev/sistem-sn/dashboardpkl/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/neru/Projects/Webdev/sistem-sn/dashboardpkl/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'session.secure','session.http_only','session.same_site','session.partitioned','session.samesite',
...
'sanctum.csrf-cookie','vendor.index','vendor.store','vendor.show','vendor.update',
'vendor.destroy',
'part.index','part.store','part.show','part.update','part.destroy',
'unit.index','unit.store','unit.show','unit.update','unit.destroy',
'transaksi.index','transaksi.store','transaksi.show','transaksi.update','transaksi.destroy',
'transaksi-vendor.index','transaksi-vendor.store','transaksi-vendor.show','transaksi-vendor.update','transaksi-vendor.destroy','inventori.index',
'inventori.store','inventori.show','inventori.update','inventori.destroy','stok-in.index','stok-in.store','stok-in.show',
'stok-in.update','stok-in.destroy',
'stok-out.index','stok-out.store','stok-out.show','stok-out.update','stok-out.destroy','kategori-part.index','kategori-part.store',
'kategori-part.show','kategori-part.update','kategori-part.destroy','users.index','users.store',
'users.show','users.update','users.destroy','historyusers.index','historyusers.store',
'historyusers.show','historyusers.update','historyusers.destroy','home',
'dashboard','dashboard.vendors','dashboard.parts','dashboard.units','dashboard.transactions',
'dashboard.transactions.new-multi','dashboard.vendor.parts','dashboard.transactions.details','dashboard.unit.parts','dashboard.best-part-prices',
'dashboard.vendor.details','profile.edit','profile.update','profile.destroy',
...
'app','report','laravel-exceptions::401','laravel-exceptions::402','laravel-exceptions::403',
